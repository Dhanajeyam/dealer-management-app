    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
          ...
          <span style={{ fontSize: '0.75rem', fontWeight: '600', color: 'var(--text-muted)', marginLeft: '0.6rem' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '0.2rem' }}>
              <span style={{ fontSize: '1.25rem', fontWeight: '800', color: 'var(--text-main)' }}>₹4,82,500</span>
              <span style={{ fontSize: '0.7rem', color: 'var(--primary)', fontWeight: '700', background: 'var(--primary-light)', padding: '0.15rem 0.4rem', borderRadius: '4px' }}>6 Brands</span>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '0.2rem' }}>
              <span style={{ fontSize: '1.25rem', fontWeight: '800', color: 'var(--text-main)' }}>14 Sales</span>
              <span style={{ fontSize: '0.7rem', color: 'var(--primary)', fontWeight: '700', background: 'var(--primary-light)', padding: '0.15rem 0.4rem', borderRadius: '4px' }}>100% Synced</span>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '0.2rem' }}>
              <span style={{ fontSize: '1.25rem', fontWeight: '800', color: 'var(--credit)' }}>₹64,200</span>
              <span style={{ fontSize: '0.7rem', color: 'var(--credit)', fontWeight: '700', background: 'var(--credit-bg)', padding: '0.15rem 0.4rem', borderRadius: '4px' }}>12 Farmers</span>
            </div>
          </div>
        </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '0.85rem' }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <span style={{ fontSize: '0.78rem', fontWeight: '700', color: 'var(--primary)', background: 'var(--primary-light)', padding: '0.2rem 0.5rem', borderRadius: '6px' }}>
                  ₹1,42,000 Val.
                </span>
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem', fontSize: '0.78rem' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.35rem 0.5rem', background: 'var(--bg-surface-hover)', borderRadius: '6px' }}>
                  <span style={{ fontWeight: '600', color: 'var(--text-main)' }}>Regent SC (Fipronil 5%)</span>
                  <span style={{ color: 'var(--primary)', fontWeight: '700' }}>32 in stock • ₹850</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.35rem 0.5rem', background: 'var(--bg-surface-hover)', borderRadius: '6px' }}>
                  <span style={{ fontWeight: '600', color: 'var(--text-main)' }}>Confidor (Imidacloprid)</span>
                  <span style={{ color: 'var(--primary)', fontWeight: '700' }}>18 in stock • ₹420</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.35rem 0.5rem', background: 'var(--bg-surface-hover)', borderRadius: '6px' }}>
                  <span style={{ fontWeight: '600', color: 'var(--text-main)' }}>Nativo Fungicide</span>
                  <span style={{ color: 'var(--primary)', fontWeight: '700' }}>15 in stock • ₹1,250</span>
                </div>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem', fontSize: '0.78rem' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.35rem 0.5rem', background: 'var(--bg-surface-hover)', borderRadius: '6px' }}>
                  <span style={{ fontWeight: '600', color: 'var(--text-main)' }}>Amistar Top (Azoxystrobin)</span>
                  <span style={{ color: 'var(--primary)', fontWeight: '700' }}>24 in stock • ₹1,680</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.35rem 0.5rem', background: 'var(--bg-surface-hover)', borderRadius: '6px' }}>
                  <span style={{ fontWeight: '600', color: 'var(--text-main)' }}>Karate Insecticide (Lambda)</span>
                  <span style={{ color: 'var(--primary)', fontWeight: '700' }}>40 in stock • ₹390</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.35rem 0.5rem', background: 'var(--bg-surface-hover)', borderRadius: '6px' }}>
                  <span style={{ fontWeight: '600', color: 'var(--text-main)' }}>Score Fungicide</span>
                  <span style={{ color: 'var(--primary)', fontWeight: '700' }}>12 in stock • ₹920</span>
                </div>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem', fontSize: '0.78rem' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.35rem 0.5rem', background: 'var(--bg-surface-hover)', borderRadius: '6px' }}>
                  <span style={{ fontWeight: '600', color: 'var(--text-main)' }}>Saaf Fungicide (Carbendazim)</span>
                  <span style={{ color: 'var(--primary)', fontWeight: '700' }}>60 in stock • ₹450</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.35rem 0.5rem', background: 'var(--bg-surface-hover)', borderRadius: '6px' }}>
                  <span style={{ fontWeight: '600', color: 'var(--text-main)' }}>Ulala (Flonicamid)</span>
                  <span style={{ color: 'var(--primary)', fontWeight: '700' }}>20 in stock • ₹1,120</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.35rem 0.5rem', background: 'var(--bg-surface-hover)', borderRadius: '6px' }}>
                  <span style={{ fontWeight: '600', color: 'var(--text-main)' }}>Lancer Gold</span>
                  <span style={{ color: 'var(--primary)', fontWeight: '700' }}>28 in stock • ₹680</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'sales' && (
          <div style={{
            ...
            <div style={{
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <span style={{ fontWeight: '800', color: 'var(--text-main)', fontSize: '0.85rem' }}>#INV-2026-084</span>
                  <span style={{ color: 'var(--text-muted)', fontSize: '0.8rem' }}>• Ramesh Kumar (Vill: Kallakurichi)</span>
                  <span style={{ fontSize: '0.72rem', fontWeight: '700', color: 'var(--success)', background: 'var(--success-bg)', padding: '0.15rem 0.45rem', borderRadius: '4px' }}>
                    Paid (Cash)
                  </span>
                </div>
            ...
            <div style={{
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <span style={{ fontWeight: '800', color: 'var(--text-main)', fontSize: '0.85rem' }}>#INV-2026-083</span>
                  <span style={{ color: 'var(--text-muted)', fontSize: '0.8rem' }}>• Murugan S (Vill: Alanganallur)</span>
                  <span style={{ fontSize: '0.72rem', fontWeight: '700', color: 'var(--credit)', background: 'var(--credit-bg)', padding: '0.15rem 0.45rem', borderRadius: '4px' }}>
        ...
        {activeTab === 'dues' && (
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.5rem' }}>
              ...
              <span style={{ fontSize: '0.75rem', color: 'var(--credit)', fontWeight: '700', background: 'var(--credit-bg)', padding: '0.2rem 0.5rem', borderRadius: '6px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '0.75rem' }}>
              <div style={{ padding: '0.75rem 1rem', background: 'var(--bg-surface-hover)', borderRadius: '10px', border: '1px solid var(--border-color)' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <span style={{ color: 'var(--credit)', fontWeight: '800', fontSize: '0.88rem' }}>₹12,400 Due</span>
                </div>
              ...
              <div style={{ padding: '0.75rem 1rem', background: 'var(--bg-surface-hover)', borderRadius: '10px', border: '1px solid var(--border-color)' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <span style={{ color: 'var(--credit)', fontWeight: '800', fontSize: '0.88rem' }}>₹8,750 Due</span>
                </div>
                <span style={{ fontSize: '0.72rem', color: 'var(--text-muted)', display: 'block', marginTop: '0.2rem' }}>
              ...
              <div style={{ padding: '0.75rem 1rem', background: 'var(--bg-surface-hover)', borderRadius: '10px', border: '1px solid var(--border-color)' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <span style={{ color: 'var(--warning)', fontWeight: '800', fontSize: '0.88rem' }}>₹3,200 Due</span>
                </div>
                <span style={{ fontSize: '0.72rem', color: 'var(--text-muted)', display: 'block', marginTop: '0.2rem' }}>
